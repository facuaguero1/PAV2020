...
class Ng_Cotizaciones
{
    ...
    {
        String sqlInsertar = "INSERT INTO Cotizaciones(numeroCotizacion, año, cuitCliente, tipoDocVendedor, numDocVendedor, codEstadoCotizacion, nombreSolicitante, " +
                            "apellidoSolicitante, fecha, observaciones, precioTotal, motivoPerdida, nomCompetidor) " +
                            "VALUES(" + Cotizacion.numeroCotizacicon + "," + Cotizacion.año + "," + Cotizacion.cuitCliente + "," + 
                            Cotizacion.tipoDocVendedor + "," + Cotizacion.numDocVendedor + "," + Cotizacion.codEstadoCotizacion + ",'" + Cotizacion.nombreSolicitante + "','" + 
                            Cotizacion.apellidoSolicitante + "'," + _BD.FormatearDato(Cotizacion.fecha, "Date") + ",'" + Cotizacion.observaciones + "'," + 
                            Cotizacion.precioTotal + ",'" + Cotizacion.motivoPerdida + "','" + Cotizacion.nomCompetidor + "')";
